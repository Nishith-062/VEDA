...
const ViewerPage = () => {
  ...
  // Fetch LiveKit token and room info
  useEffect(() => {
  ...
  // Connect to room
useEffect(() => {
  if (!streamData.wsUrl || !streamData.token) return; // only connect if valid
  ...
  const connectRoom = async () => {
    try {
      ...
      const handleDisconnected = () => navigate("/student");
  ...
  return () => {
    ...
    room.off("disconnected", () => navigate("/student"));
    if (room.state === "connected") {
      room.disconnect().catch(() => {});
    }
  };
}, [streamData.wsUrl, streamData.token, room, navigate]);
  ...
  return (
    <RoomContext.Provider value={room}>
      <div
        ...
        style={{ height: "100vh", position: "relative", background: "#0f0f0f" }}
      >
        <QualityControlPanel
    ...
    >
      ...
      {expanded && (
        <div style={{ marginTop: "15px" }}>
          ...
          >
            <div
              style={{ color: "#60a5fa", fontSize: "11px", lineHeight: "1.5" }}
            >
...
function MyVideoConference({ streamMode }) {
  ...
  if (streamMode === "audio-only") {
    return (
      ...
      >
        <div
          style={{ textAlign: "center", maxWidth: "450px", padding: "20px" }}
        >
          <div
            style={{
              fontSize: "80px",
          ...
          >
            You're listening to the stream without video to save bandwidth (~50
            Kbps).
          </p>
          <div
            style={{
          ...
          >
            ...
            >
              <div
                style={{ fontSize: "11px", opacity: 0.6, marginBottom: "4px" }}
              >
                PARTICIPANTS
              </div>
              <div
